...
class VacuumActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.vacuum_layout)
    ...
    private fun clickedCardView() {
        findViewById<CardView>(R.id.vacuumCard1).setOnClickListener {
            val intent = Intent(this@VacuumActivity, VacuumDetailsActivity::class.java)
